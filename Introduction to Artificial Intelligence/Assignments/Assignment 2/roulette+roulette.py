...
def main():
    ...
    with open("best_keyframes_roulette+roulette.txt", "w") as f:
        ...
        for keyframe in bestCheetah:
            ...
            f.write(line + "\n")
    print("Best keyframes saved to 'best_keyframes_roulette+roulette.txt'!")

    plt.figure(figsize=(10, 5))
    plt.plot(range(numGenerations), rewardsHistory, marker='o', color='y', linestyle='-')
    plt.title("Roulette Parents + Roulette Survivors")
    plt.xlabel("Generation")
    plt.ylabel("Best Episode Reward")
    plt.grid(True)
    plt.savefig("roulette+roulette.png")
    plt.show()
